        ...
        return __generator(this, function (_b) {
            switch (_b.label) {
                case 0:
                    ...
                    return [4 /*yield*/, axios_1.default.get('https://api.open-meteo.com/v1/forecast', { params: params })];
                case 1:
                    result = _b.sent();
