...
export function getCurrentWeather(_a) {
        ...
        return __generator(this, function (_b) {
            switch (_b.label) {
                case 0:
                    ...
                    return [4 /*yield*/, axios.get('https://api.open-meteo.com/v1/forecast', { params: params })];
                case 1:
                    result = _b.sent();
...
export function getHourlyWeather(_a) {
    var latitude = _a.latitude, longitude = _a.longitude;
    return __awaiter(this, void 0, void 0, function () {
        var params, result;
        return __generator(this, function (_b) {
...
export function getDailyWeather(_a) {
    var latitude = _a.latitude, longitude = _a.longitude;
    return __awaiter(this, void 0, void 0, function () {
        var params, result;
        return __generator(this, function (_b) {
